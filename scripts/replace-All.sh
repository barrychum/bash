...
printf "Do you want to proceed with these file paths? (y/n): "
read proceed_file_paths
...
printf "Do you want to proceed with these replacements? (y/n): "
read proceed_replacements
